...
- **New 2026-09-12, design note E.161 — Heinz Guderian's *Panzer Leader*, checked for a Panzergrenadier organizational or equipment-allocation detail: found, but too coarse to move any of the gaps above.** As the newly-appointed Inspector-General of Armored Troops, Guderian records that "towards the end of March [1943], the new organization for our Panzergrenadiers was decided upon in accordance with our latest experience" (PDF p.167 of `reference/operational-histories/epdf.pub_panzer-leader-pdf-5ecced7677a19.pdf`, `pdftotext`'s own page-break count — no printed pagination survives extraction) — a real, dated, first-person confirmation that a Panzergrenadier war-establishment revision was personally driven by Guderian in March 1943, plausibly upstream of the KStN 1114 table (dated 1 November 1943) already used in this file, but given with zero organizational detail (no squad/platoon/weapon breakdown of any kind). His own 9 March 1943 conference notes (item 8, PDF p.165) separately name "the continued mass-production in sufficient volume of the 3-ton armored troop-carrying vehicle [the Sd.Kfz. 251 half-track] without any further alteration to its design" as "the main problem" for Panzergrenadiers specifically — a production-continuity policy decision, not a TOE figure, but a genuine, citable data point on why the SPW-mounted (gepanzert) Panzergrenadier variant flagged as an open gap above kept the same vehicle design throughout 1943. Neither detail is precise enough to close any Open Question above; both are recorded here as the closest existing home for this material rather than a new file.
- **New 2026-09-12, design note E.164 — Nick Adams' *German Infantry in Action WWII* (Verlinden Publications, WarMachines 16, `reference/infantry-toe/epdf.pub_german-infantry-in-wwii-warmachines-16.pdf`, 38pp) checked in full against this file's existing German infantry TOE and `infantry_calc` pipeline: a clean confirmation of `reference/CATALOG.md`'s existing "photo-reference album, not a TOE/tactics text" flag, not a new finding.** Every one of the book's 38 pages was read via the Read tool's `pages` parameter; the entire book is period-reenactor colour photography (uniforms, webbing, weapon-handling poses) with short equipment-identification captions aimed at scale-modellers — no organizational table, no unit-strength figure, no weapon-loadout table, and no squad/platoon breakdown anywhere. The handful of location/unit captions present ("Waffen SS patrol... in the hedgerows of Normandy," "The ZB30 machine gunner from the 'Prinz Eugen' Division in the Balken forests") are undated or dated 1944, outside this project's 1943 baseline, and none rises above a single-line photo caption — no usable flavor-text anecdote (with a name, date, and action) was found. No addition to this file's squad/platoon/company tables or Open Questions is warranted.
