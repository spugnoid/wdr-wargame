...
*Sourcing note (E.152): Pegler also left a real, unresolved tension for the Japanese sniper row — Army-trained marksmen under Col Namio Tatsumi's guidance versus Special Naval Landing Force troops using tree-position "sniper tactics" without matching marksmanship training. Dr Stephen Bull's* World War II Jungle Warfare Tactics *(Osprey Elite 151), being specifically about Pacific/jungle tactics, was checked as a plausible source to disentangle this — it came back a clean negative. The book never mentions Tatsumi, a dedicated Army marksmanship program, or scoped rifles; its only description of Japanese sniping is doctrinal and organizational ("the Japanese habit was to establish an outpost line consisting mainly of snipers and observers, who would act as a tripwire," pp.54-55), applied to Japanese infantry positions generally rather than broken out by which population of snipers is meant. Left exactly as ambiguous as Pegler left it. See* ``counters/toe/jungle_warfare_rottman_1943.md`` *for full citations.*
