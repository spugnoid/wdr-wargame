...
*NOTE: the check adds a small modifier rather than the full Morale value, which keeps the quality spread intact while placing thresholds in honest 1d6 space — a threshold of 4 means a regular unit holds half the time.*
