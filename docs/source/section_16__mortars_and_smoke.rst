...
All mortar counters use M2 F1 (mobile) or M0 F2 (deployed), per Rule 6.6.2. Mortar teams must deploy before firing — same deploy/limber rules as HMG teams (Section 7.6).
